"""Render the long-form opportunity brief — DOCX + PDF."""
...
OUT_DOCX = ROOT / "02_LongForm_Report" / "CS_Analytical_Opportunity_Brief_long.docx"
OUT_PDF = ROOT / "02_LongForm_Report" / "CS_Analytical_Opportunity_Brief_long.pdf"
...
def render_docx(blocks, out: Path):
    ...
    def set_run_font(run, *, size, color=CHARCOAL, bold=False, italic=False):
        run.font.name = "Adobe Caslon Pro"
    ...
    def add_callout(title, body):
        ...
        add_para(body, size=11, color=CHARCOAL, space_after=12,
                 left_indent=0.3, line_spacing=1.4)
